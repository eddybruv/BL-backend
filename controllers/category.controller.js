...
const createCategory = async (req, res) => {
  ...
  const newCategory = await categoryModel.create({name, description, userId, image});
...
const updateCategory = async (req, res) => {
  ...
  if(findCat) {
    ...
    const updatedCat = await categoryModel.findByIdAndUpdate({_id}, {name, description, image});
